...
class ENCRYPTION_API Encryption
{
	public:
        ...
        static std::vector<unsigned char> encrypt(std::vector<unsigned char>& input, std::vector<unsigned char>& key, Mode mode);
		static std::string decrypt(std::string iv, std::string key, Mode mode = AES256);
        static std::vector<unsigned char> decrypt(std::vector<unsigned char>& input, std::vector<unsigned char>& key, Mode mode);
	...
	private:
        ...
        static void invCipher(std::vector<std::vector<unsigned char>>& state, std::vector<std::vector<unsigned char>>& keySchedule, Mode mode);
        ...
        static std::vector<unsigned char> convertToVector(std::vector<std::vector<unsigned char>> in);
